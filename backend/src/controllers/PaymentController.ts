...
export class PaymentController {
  ...
  async processCheckout(req: Request, res: Response) {
    try {
      ...
      // Mercado Pago links the generated card token to the payer's email.
      // Overwriting the email here invalidates the token, causing "Card Token not found" errors.
      // We must leave paymentData.payer.email as it was generated by the frontend.
